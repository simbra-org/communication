...
This repository contains the source files for the communication materials of the Interdisciplinary Brazilian Symposium on Agent-Based Models ([SIMBRA](https://simbra.com.br)).
...
To start or join a conversation about a specific topic, visit the [Discussions tab](https://github.com/simbra-org/communication/discussions).

Before opening a new issue, please check the [issues tab](https://github.com/simbra-org/communication/issues) to see if your topic has already been reported.
